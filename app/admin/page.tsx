  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
        {stats.map((stat) => (
          <div key={stat.label} className="bg-white/5 border border-white/10 p-6 rounded-2xl hover:bg-white/[0.07] transition-colors group">
        ...
        <div className="lg:col-span-2 bg-white/5 border border-white/10 p-8 rounded-2xl">
          <div className="flex items-center justify-between mb-8">
            <div>
              ...
              <p className="text-sm text-white/50">Real-time bandwidth usage across all routers</p>
            </div>
          ...
          <DashboardCharts data={trafficData} />
        </div>
                ...
                <div key={alert.id} className="flex gap-4">
                  ...
                  <div className="flex-1">
                    <div className="flex justify-between items-start">
                      <span className="text-xs font-bold uppercase tracking-wider text-white/30">{alert.type}</span>
                      <span className="text-xs text-white/30">{formatDistanceToNow(new Date(alert.createdAt))} ago</span>
                    </div>
