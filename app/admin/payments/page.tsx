          ...
          <table className="w-full text-left">
            <thead>
              <tr className="border-b border-white/10 bg-white/5">
                ...
                <th className="px-6 py-4 text-xs font-bold uppercase tracking-wider text-white/30">Method</th>
              ...
              {payments.length > 0 ? (
                payments.map((payment) => (
                  <tr key={payment.id} className="hover:bg-white/[0.02] transition-colors group">
                    ...
                    <td className="px-6 py-4">
                      <span className="text-xs px-2 py-1 rounded bg-white/5 border border-white/10">{payment.method}</span>
                    </td>
                    <td className="px-6 py-4">
                      <span className={cn(
