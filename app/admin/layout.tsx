...
export default function AdminLayout({ children }: { children: React.ReactNode }) {
  ...
  return (
    <div className="flex h-screen bg-[#0a0a0a] text-white">
      ...
      {/* Main Content */}
      <main className="flex-1 overflow-y-auto bg-gradient-to-b from-[#0a0a0a] to-[#0f0f0f]">
        <header className="h-16 border-b border-white/10 flex items-center justify-between px-8 bg-[#0a0a0a]/50 backdrop-blur-xl sticky top-0 z-10">
